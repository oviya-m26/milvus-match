...
const DemoMatch = () => {
  ...
  const candidate = useMemo(
    () => ({
      ...
      categoryTags: categoryTags.split(",").map((s) => s.trim()).filter(Boolean),
  ...
  return (
    <>
      ...
      <section className=" container mx-auto px-4 py-6 ">
        <h1 className="text-3xl font-bold text-black mb-2">AI Matchmaking Demo</h1>
        <p className="text-gray-600 mb-6">Try the smart placement engine without logging in.</p>
